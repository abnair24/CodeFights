# You're given two integers, n and m. Find position of the rightmost bit in which they differ in their binary r' \
#    'epresentations (it is guaranteed that such a bit exists), counting from right to left.
#
